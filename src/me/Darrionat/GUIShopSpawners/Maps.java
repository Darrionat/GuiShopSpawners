...
public class Maps {
	HashMap<Integer, String> mobs = new HashMap<Integer, String>();

	public HashMap<Integer, String> getMobMap() {
		mobs.put(1, "Creeper");
		mobs.put(2, "Skeleton");
		mobs.put(3, "Spider");
		mobs.put(4, "Iron_golem");
		mobs.put(5, "Zombie");
		mobs.put(6, "Slime");
		mobs.put(7, "Witch");
		mobs.put(8, "Zombie_pigman");
		mobs.put(9, "Enderman");
		mobs.put(10, "Cave_spider");
		mobs.put(11, "Vindicator");
		mobs.put(12, "Cow");
		mobs.put(13, "Rabbit");
		mobs.put(14, "Sheep");
		mobs.put(15, "Horse");
		...
		mobs.put(19, "Squid");
		mobs.put(20, "Wolf");
		mobs.put(21, "Mooshroom");
		mobs.put(22, "Wither_skeleton");
		mobs.put(23, "Ender_dragon");
		mobs.put(24, "Wither");
		mobs.put(25, "Ghast");
		mobs.put(26, "Guardian");
		mobs.put(27, "Shulker");
		mobs.put(28, "Ocelot");
		mobs.put(29, "Polar_bear");
		mobs.put(30, "Llama");
		mobs.put(31, "Parrot");
		mobs.put(32, "Turtle");
		mobs.put(33, "Phantom");
		...
		mobs.put(35, "Panda");
		mobs.put(36, "Dolphin");
		mobs.put(37, "Pillager");
		mobs.put(38, "Villager");

		mobs.put(39, "Iron_golem");
		mobs.put(40, "Zombie_pigman");
		mobs.put(41, "Cave_spider");
		mobs.put(42, "Mooshroom");
		mobs.put(43, "Wither_skeleton");
		mobs.put(44, "Ender_dragon");
		return mobs;
	}

	HashMap<Integer, String> sellmobs = new HashMap<Integer, String>();

	public HashMap<Integer, String> getSellMobMap() {
		sellmobs.put(1, "Creeper");
		sellmobs.put(2, "Skeleton");
		sellmobs.put(3, "Spider");
		sellmobs.put(4, "Iron_golem");
		...
		sellmobs.put(12, "Cow");
		sellmobs.put(13, "Rabbit");
		sellmobs.put(14, "Sheep");
		sellmobs.put(15, "Horse");
		sellmobs.put(16, "Blaze");
		sellmobs.put(17, "Pig");
		sellmobs.put(18, "Chicken");
		sellmobs.put(19, "Squid");
		sellmobs.put(20, "Wolf");
		sellmobs.put(21, "Mushroom_cow");
		sellmobs.put(22, "Wither_skeleton");
		sellmobs.put(23, "Ender_dragon");
		sellmobs.put(24, "Wither");
		sellmobs.put(25, "Ghast");
		sellmobs.put(26, "Guardian");
		sellmobs.put(27, "Shulker");
		sellmobs.put(28, "Ocelot");
		sellmobs.put(29, "Polar_bear");
		sellmobs.put(30, "Llama");
		sellmobs.put(31, "Parrot");
		sellmobs.put(32, "Turtle");
		sellmobs.put(33, "Phantom");
		sellmobs.put(34, "Drowned");
		sellmobs.put(35, "Panda");
		sellmobs.put(36, "Dolphin");
		sellmobs.put(37, "Pillager");
		...
		sellmobs.put(44, "Ender dragon");

		return sellmobs;
	}

	HashMap<Integer, String> skullmap = new HashMap<Integer, String>();
	...
	/*
	 * HashMap<String, String> nameskullmap = new HashMap<String, String>();
	 * 
	 * public HashMap<String, String> getNameSkullMap() {
	 * nameskullmap.put("Creeper", "MHF_Creeper"); nameskullmap.put("Skeleton",
	 * "MHF_Skeleton"); nameskullmap.put("Spider", "MHF_Spider");
	 * nameskullmap.put("Iron_Golem", "MHF_Golem"); nameskullmap.put("Zombie",
	 * "MHF_Zombie"); nameskullmap.put("Slime", "MHF_Slime");
	 * nameskullmap.put("Witch", "MHF_Witch"); nameskullmap.put("Zombie_Pigman",
	 * "MHF_PigZombie"); nameskullmap.put("Enderman", "MHF_Enderman");
	 * nameskullmap.put("Cave_Spider", "MHF_CaveSpider");
	 * nameskullmap.put("Vindicator", "Vindicator"); // Actual skin name
	 * nameskullmap.put("Cow", "MHF_Cow"); nameskullmap.put("Rabbit", "MHF_Rabbit");
	 * nameskullmap.put("Sheep", "MHF_Sheep"); nameskullmap.put("Horse",
	 * "dominodoggy"); // horse nameskullmap.put("Blaze", "MHF_Blaze");
	 * nameskullmap.put("Pig", "MHF_Pig"); nameskullmap.put("Chicken",
	 * "MHF_Chicken"); nameskullmap.put("Squid", "MHF_Squid");
	 * nameskullmap.put("Wolf", "MHF_Wolf"); nameskullmap.put("Mooshroom",
	 * "MHF_MushroomCow"); nameskullmap.put("Wither_Skeleton", "MHF_WSkeleton");
	 * nameskullmap.put("Ender_Dragon", "xLief"); // enderdragon
	 * nameskullmap.put("Wither", "MHF_Wither"); nameskullmap.put("Ghast",
	 * "MHF_Ghast"); nameskullmap.put("Guardian", "MHF_Guardian");
	 * nameskullmap.put("Shulker", "MHF_Shulker"); nameskullmap.put("Ocelot",
	 * "MHF_Ocelot"); nameskullmap.put("Polar_Bear", "Bobkatamurda"); // Polar Bear
	 * nameskullmap.put("Llama", "DiamondClan"); // Llama nameskullmap.put("Parrot",
	 * "doctorpoo"); // parrot nameskullmap.put("Turtle", "MHF_Turtle");
	 * nameskullmap.put("Phantom", "Complexs"); // Phantom
	 * nameskullmap.put("Drowned", "MHF_Drowned"); // drowned
	 * nameskullmap.put("Panda", "Bu14H"); // panda nameskullmap.put("Dolphin",
	 * "ChunkySteakBake"); // dolphin (water) nameskullmap.put("Pillager",
	 * "CarlosSantos"); // pillager return nameskullmap;
	 * 
	 * }
	 */
	 ...
	 * HashMap<Integer, String> skullmap = new HashMap<Integer, String>();
	 * 
	 * public HashMap<Integer, String> getSkullMap() { skullmap.put(1,
	 * "MHF_Creeper"); skullmap.put(2, "MHF_Skeleton"); skullmap.put(3,
	 * "MHF_Spider"); skullmap.put(4, "MHF_Golem"); skullmap.put(5, "MHF_Zombie");
	 * skullmap.put(6, "MHF_Slime"); skullmap.put(7, "MHF_Witch"); skullmap.put(8,
	 * "MHF_PigZombie"); skullmap.put(9, "MHF_Enderman"); skullmap.put(10,
	 * "MHF_CaveSpider"); skullmap.put(11, "Vindicator"); // Actual skin name
	 * skullmap.put(12, "MHF_Cow"); skullmap.put(13, "MHF_Rabbit"); skullmap.put(14,
	 * "MHF_Sheep"); skullmap.put(15, "dominodoggy"); // horse skullmap.put(16,
	 * "MHF_Blaze"); skullmap.put(17, "MHF_Pig"); skullmap.put(18, "MHF_Chicken");
	 * skullmap.put(19, "MHF_Squid"); skullmap.put(20, "MHF_Wolf"); skullmap.put(21,
	 * "MHF_MushroomCow"); skullmap.put(22, "MHF_WSkeleton"); skullmap.put(23,
	 * "xLief"); // enderdragon skullmap.put(24, "MHF_Wither"); skullmap.put(25,
	 * "MHF_Ghast"); skullmap.put(26, "MHF_Guardian"); skullmap.put(27,
	 * "MHF_Shulker"); skullmap.put(28, "MHF_Ocelot"); skullmap.put(29,
	 * "Bobkatamurda"); // Polar Bear skullmap.put(30, "DiamondClan"); // Llama
	 * skullmap.put(31, "doctorpoo"); // parrot skullmap.put(32, "MHF_Turtle");
	 * skullmap.put(33, "Complexs"); // Phantom skullmap.put(34, "MHF_Drowned"); //
	 * drowned skullmap.put(35, "Bu14H"); // panda skullmap.put(36,
	 * "ChunkySteakBake"); // dolphin (water) skullmap.put(37, "CarlosSantos"); //
	 * pillager return skullmap; }
	 */
}
